...
begin
  ...
  if((edtUsuario.Text<>'') or (edtSenha.Text<>'')) then // se usuario ou senha não estiver em branco
  begin
    ...
    begin
      ...
      begin
        ...
        frmPrincipal.lblNomeUsuario.Caption := 'Usuário: ' + TFDStoredProc(srcLogin.DataSet).FieldByName('nome').AsString;
        ...
        ShowMessage('Usuario não está ativo');
    end
    else
      ShowMessage('Usuário ou senha inválidos!');
  end
  else
    ShowMessage('Não deixe os campos em branco');
end;

procedure TfrmLogin.btnAutoPreencherClick(Sender: TObject);
begin
  // pra não ficar digitando usuario e senha constantemente
